...
jerome = User.create({email: "jerome@gmail.com", password: "123soleil", name: 'Jerome & Arnaud', sex: 'Male & Male'})
lea = User.create({email: "lea@gmail.com", password: "123soleil", name: 'Lea & Mathieu', sex: 'Female & Female'})
leo = User.create({email: "leo@gmail.com", password: "123soleil", name: 'Kim & Leo', sex: 'Male & Female'})
